...
export default function BudgetsPage() {
  ...
  function getStatusBadge(spent: number, budget: number, threshold: number) {
    const percentage = (spent / budget) * 100;
    if (percentage >= 100) {
      return <span className="px-2 py-1 bg-red-100 text-red-800 text-xs rounded-full font-medium">Over Budget</span>;
    }
    if (percentage >= threshold * 100) {
      return <span className="px-2 py-1 bg-yellow-100 text-yellow-800 text-xs rounded-full font-medium">Near Limit</span>;
    }
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className={`px-2 py-0.5 text-xs rounded-full font-medium ${
                          budget.profile === 'business' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                        }`}>
                          {budget.profile === 'business' ? 'Business' : 'Personal'}
                        </span>
            ...
            <form onSubmit={createBudget} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  You'll see a warning when spending reaches {formData.alert_threshold}% of your budget
                </p>
              </div>
