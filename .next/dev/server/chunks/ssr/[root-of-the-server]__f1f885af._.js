...
"[project]/app/(sitesense)/estimates/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EstimatesListPage() {
    ...
    async function load() {
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('estimates').select('id, status, total, created_at, public_token, po_number, jobs(name)').order('created_at', {
                ascending: false
            });
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (!q) return rows;
        return rows.filter((r)=>(r.jobs?.name || '').toLowerCase().includes(q) || (r.status || '').toLowerCase().includes(q) || (r.po_number || '').toLowerCase().includes(q) || r.id.toLowerCase().includes(q));
    }, [
        rows,
        query
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f1f885af._.js.map