...
function BudgetsPage() {
    ...
    async function loadCategories() {
        ...
        if (!user) return;
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('categories').select('id, name, icon').order('name');
    ...
    async function loadBudgets() {
        try {
            ...
            // Load budgets
            const { data: budgetsData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('budgets').select('*').eq('user_id', user.id).eq('is_active', true).order('category');
            if (error) throw error;
            // Calculate spending for each budget
            const budgetsWithSpending = await Promise.all((budgetsData || []).map(async (budget)=>{
    ...
    async function calculateSpending(userId, budget) {
        const now = new Date();
        let startDate;
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('expenses').select('amount').eq('user_id', userId).gte('date', startDate.toISOString().split('T')[0]);
        ...
        // If category is not "All Categories", filter by it
        if (budget.category !== 'All Categories') {
            // We need to join with categories table or use category name directly
            // For simplicity, we'll use a subquery approach
            const { data: categoryData } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('categories').select('id').eq('name', budget.category).single();
            if (categoryData) {
    ...
    async function createBudget(e) {
        ...
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('budgets').insert({
                user_id: user.id,
    ...
    async function deleteBudget(id) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('budgets').update({
            is_active: false
        }).eq('id', id);
        if (!error) {
            loadBudgets();
    ...
    function getProgressColor(spent, budget, threshold) {
        const percentage = spent / budget * 100;
        if (percentage >= 100) return 'bg-red-500';
        if (percentage >= threshold * 100) return 'bg-yellow-500';
        return 'bg-green-500';
    }
    function getStatusBadge(spent, budget, threshold) {
        const percentage = spent / budget * 100;
        if (percentage >= 100) {
                    ...
                    budgets.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Create your first budget to start tracking your spending against your goals."
                            }, void 0, false, {
                                fileName: "[project]/app/budgets/page.tsx",
                                lineNumber: 272,
                                columnNumber: 13
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: `px-2 py-0.5 text-xs rounded-full font-medium ${budget.profile === 'business' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'}`,
                                                                children: budget.profile === 'business' ? 'Business' : 'Personal'
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/budgets/page.tsx",
                                                                lineNumber: 293,
                                                                columnNumber: 25
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: `h-3 rounded-full transition-all ${getProgressColor(spent, budget.amount, budget.alert_threshold)}`,
                                                    style: {
                                                        width: `${percentage}%`
                                                    }
                                                }, void 0, false, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                "You'll see a warning when spending reaches ",
                                                formData.alert_threshold,
                                                "% of your budget"
                                            ]
                                        }, void 0, true, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: saving ? 'Creating...' : 'Create Budget'
                                        }, void 0, false, {
                                            fileName: "[project]/app/budgets/page.tsx",
                                            lineNumber: 433,
                                            columnNumber: 17
...
_s(BudgetsPage, "dnTNbpTDxIzEvisRi5hiA7uGEg4=");
_c = BudgetsPage;
var _c;
...
//# sourceMappingURL=_328c42f5._.js.map